        ...
        <form class="max-w-lg mx-auto">
            <div class="flex">
                <div class="w-full flex">
                    <input type="search" id="search-dropdown" class="block h-[10vh] min-h-[60px] rounded-l-3xl py-2.5 px-5 w-full z-20 bg-black/50 text-white text-[16px] lg:text-[24px] backdrop-blur-sm focus:ring-blue-500 placeholder:font-bold placeholder:lg:text-[24px] placeholder:text-[16px]  placeholder:text-white" placeholder="Buscar..." required />

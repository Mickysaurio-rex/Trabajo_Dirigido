    ...
    return (
        <div className="bg-gradient-to-br from-[#FFE09E] to-[#F6BF49] w-[100%] md:w-[80%] lg:w-[80%] min-h-[220px] h-[35vh] rounded-[30px] p-5 drop-shadow-lg">
            <div className="w-full h-full border-4 border-[#785200] flex flex-col justify-around items-center" >
                <h2 className="text-[32px] font-bold text-[#785200] uppercase">
                    {tittle}
                </h2>
                <button 
                onClick={handle}
                className="bg-[#785200] rounded-[20px] w-[35%] h-[25%] flex flex-row justify-center items-center gap-5 text-[#FACE71] transition hover:scale-110 hover:shadow-xl">
                    <p className="font-bold text-[20px]">Vamos</p>

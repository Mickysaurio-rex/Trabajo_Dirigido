...
const { setCategoria } = useCategory();
...
const navigate = useNavigate();
    ...
    return (
        <div className="bg-gradient-to-br from-[#FFE09E] to-[#F6BF49] w-full md:w-[90%] lg:w-[80%] min-h-[220px] h-[35vh] rounded-[30px] p-5 drop-shadow-lg">
            <div className="w-full h-full border-4 border-[#785200] flex flex-col justify-around items-center" >
                ...
                type='button'
                onClick={handle}
                className="bg-[#785200] rounded-[20px] w-[35%] h-[25%] md:min-w-[150px] flex flex-row justify-center items-center gap-5 text-[#FACE71] transition hover:scale-110 hover:shadow-xl p-2">
